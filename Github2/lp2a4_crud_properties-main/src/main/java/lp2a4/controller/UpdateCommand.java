...
public class UpdateCommand implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ( dao.update(aluno) ) {
			response.getWriter().append("A atualização do aluno ocorreu corretamente.");
		} else {
			response.getWriter().append("A atualização do aluno não ocorreu, pois algum erro foi encontrado.");			
		}
	}
